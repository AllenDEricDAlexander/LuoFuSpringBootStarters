package top.atluofu.middleware.whitelist;
 ...
 * @description: AOP
 * @author: 有罗敷的马同学
 * @datetime: 2025Year-01Month-17Day-11:27
 * @Version: 1.0
 */
...
public class DoJoinPoint {
    ...
    @Pointcut("@annotation(top.atluofu.middleware.whitelist.annotation.DoWhiteList)")
